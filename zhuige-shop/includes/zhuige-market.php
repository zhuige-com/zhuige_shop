...
<?php
	...
	{
		wp_enqueue_script('lib-layer', ZHUIGE_SHOP_BASE_URL . 'admin/js/layer/layer.js', ['jquery'], '1.0', false);
		wp_enqueue_script('zhuige-market-js', ZHUIGE_SHOP_BASE_URL . 'admin/js/zhuige-market.js', array('jquery', 'lib-layer'), '1.0.', true);
	}

	//加载css - 插件市场
	function enqueue_style_zhuige_market()
	{
		wp_enqueue_style('zhuige-market-css', ZHUIGE_SHOP_BASE_URL . 'admin/css/zhuige-market.css');
	}
}
